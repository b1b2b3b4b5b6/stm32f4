...
unsigned long lwip_localtime;		//lwip本地时间计数器,单位:ms
...
void lwip_periodic_handle()
{
	...
	if (lwip_localtime - DHCPfineTimer >= DHCP_FINE_TIMER_MSECS)
	{
		...
		{ 
			//printf("lwip_dhcp_process_handle........500ms\n");
