...
void clock_init(void)
{
	...
	gpio_init_pin(GPIOA,GPIO_Pin_15,GPIO_Mode_IN,GPIO_OType_PP,GPIO_PuPd_UP);
	gpio_init_pin(GPIOB,GPIO_Pin_3,GPIO_Mode_IN,GPIO_OType_PP,GPIO_PuPd_UP);	
	gpio_init_pin(GPIOB,GPIO_Pin_4,GPIO_Mode_IN,GPIO_OType_PP,GPIO_PuPd_UP);			//只开启SW调试io口，A13，A14	 
	
	RCC_AHB3PeriphClockCmd(RCC_AHB3Periph_FSMC,ENABLE);		//开启FSMC
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_SPI2,ENABLE);			//开启SPI2
