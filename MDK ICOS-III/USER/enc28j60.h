...
//All rights reserved									  
//////////////////////////////////////////////////////////////////////////////////
#define	ENC28J60_CS_GPIO		GPIOC
#define	ENC28J60_CS_PIN			GPIO_Pin_0	   
#define	ENC28J60_CS_OUT			gpio_init_pin(ENC28J60_CS_GPIO,ENC28J60_CS_PIN,GPIO_Mode_OUT,GPIO_OType_PP,GPIO_PuPd_UP)
#define	ENC28J60_CS_SET			GPIO_SetBits(ENC28J60_CS_GPIO,ENC28J60_CS_PIN)
#define	ENC28J60_CS_RESET		GPIO_ResetBits(ENC28J60_CS_GPIO,ENC28J60_CS_PIN)

#define	ENC28J60_RST_GPIO		GPIOC
#define	ENC28J60_RST_PIN		GPIO_Pin_1	   
#define	ENC28J60_RST_OUT		gpio_init_pin(ENC28J60_RST_GPIO,ENC28J60_RST_PIN,GPIO_Mode_OUT,GPIO_OType_PP,GPIO_PuPd_UP)
#define	ENC28J60_RST_SET		GPIO_SetBits(ENC28J60_RST_GPIO,ENC28J60_RST_PIN)
#define	ENC28J60_RST_RESET		GPIO_ResetBits(ENC28J60_RST_GPIO,ENC28J60_RST_PIN)

#define	ENC28J60_INT_GPIO		GPIOE
#define	ENC28J60_INT_PIN		GPIO_Pin_0	   //ENC28J60中断引脚
#define ENC28J60_INT_IN			gpio_init_pin(ENC28J60_INT_GPIO,ENC28J60_INT_PIN,GPIO_Mode_IN,GPIO_OType_PP,GPIO_PuPd_UP)
#define ENC28J60_INT_R			GPIO_ReadInputDataBit(ENC28J60_INT_GPIO,ENC28J60_INT_PIN)
...
typedef struct{
	u8 enc28j60bank;	//ENC28J60当前使用的控制寄存器块
